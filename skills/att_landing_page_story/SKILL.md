...
- Use file inspection to load existing page copy and analytics data before restructuring.
...
- Use web search tools to review competitor landing pages and find structural gaps.
