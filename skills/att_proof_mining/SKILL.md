...
- When source material is in files (support exports, chat logs, review CSVs), use file inspection to load them directly.
- When proof references external claims (stats, benchmarks), use web search tools to verify before including.
